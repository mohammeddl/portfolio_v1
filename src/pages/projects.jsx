...
export default function Projects() {
  ...
  const headline = "Bienvenue au cœur de mon portfolio"
  ...
  return (
    <>
      ...
      {/* En-tête animé pour les projets */}
      <div className="bg-gradient-to-r from-zinc-100 to-zinc-200 dark:from-zinc-900 dark:to-zinc-800 py-8 mb-8 animate-gradient-x">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-zinc-800 dark:text-zinc-100 text-center mb-4">{headline}</h1>
          <p className="text-xl text-zinc-600 dark:text-zinc-400 text-center max-w-3xl mx-auto">{intro}</p>
        </div>
      </div>
      ...
      {/* Ajouter des styles pour l'animation du gradient */}
      <style jsx>{`
...
884-1.06-1.06-.884.883 1.06 1.06Zm4.95 2.121-1.414 1.414 1.06 1.06 1.415-1.413-1.06-1.061Zm0-3.536a2.5 2.5 0 0 1 0 3.536l1.06 1.06a4 4 0 0 0 0-5.656l-1.06 1.06Zm-4.95 4.95a2.5 2.5 0 0 1 0-3.535L6.344 12a4 4 0 0 0 0 5.656l1.06-1.06Zm-1.06 1.06a4 4 0 0 0 5.657 0l-1.061-1.06a2.5 2.5 0 0 1-3.535 0l-1.061 1.06Zm7.07-7.07-.176-.177-1.06 1.06.176.178 1.06-1.061Z"
        fill="currentColor"
      />
    </svg>
  )
